...
function Navbar() {
    ...
    return (<div className='py-3'>
        <nav
            className={currentUser && route.pathname !== '/' ? 'flex flex-wrap justify-between items-center sticky top-0 px-5 mx-auto' : 'flex flex-wrap justify-between items-center max-w-5xl mx-auto'}>
            <div className="logo">
                <NavLink to='/'>
