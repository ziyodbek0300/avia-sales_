...
import Logo2 from '../../static/images/qanot-sharq.jpg'
    ...
    return (
        <footer>
            <div className="max-w-5xl mx-auto border-t flex justify-between py-4 flex-wrap">
                <img src={Logo1} width="120" height="120" style={{ objectFit: 'contain' }} alt="airways" />
                <img src={Logo2} width="120" height="120" style={{ objectFit: 'contain' }} alt="airways" />
                <img src={Logo3} width="120" height="120" style={{ objectFit: 'contain' }} alt="airways" />
