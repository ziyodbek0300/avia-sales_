      ...
      <div className={"py-3 max-w-5xl m-auto"}>
        {tickets.length === 0 ? (
          ...
          tickets.map((a, b) => {
            ...
            let aaa =
              Math.floor(totalTimeInMin / 60) + ":" + (totalTimeInMin % 60);
            return (
              <NavLink
                onClick={() =>
              ...
              >
                <div
                  className={
                    "p-3 mb-3 shadow hover:shadow-md cursor-pointer transition-all rounded-lg border flex"
                  }
                >
                  <div className={"w-full px-2 pr-5"}>
                    ...
                    <div className={"flex justify-between"}>
                      ...
                      <div
                        className={
                          "flex w-full bg-red-500 text-white mx-3 justify-between px-6 rounded border-b-2 border-dotted border-gray-500 h-10 align-bottom p-3"
                        }
                      >
                  ...
                  <div
                    className={
                      "border-l p-3 flex justify-center items-center w-60"
                    }
                  >
                    {!isTransfer ? (
