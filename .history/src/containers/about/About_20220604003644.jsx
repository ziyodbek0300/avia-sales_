...
function About() {
    return (
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='my-3'>
                <div style="position:relative;overflow:hidden;"><a href="https://yandex.com/maps/10335/tashkent/?utm_medium=mapframe&utm_source=maps" style="color:#eee;font-size:12px;position:absolute;top:0px;">Toshkent</a><a href="https://yandex.com/maps/10335/tashkent/?ll=69.252730%2C41.330730&mode=whatshere&utm_medium=mapframe&utm_source=maps&whatshere%5Bpoint%5D=69.248940%2C41.333729&whatshere%5Bzoom%5D=14.18&z=14.18" style="color:#eee;font-size:12px;position:absolute;top:14px;">Sebzor mahallasi — Yandex Xarita</a><iframe src="https://yandex.com/map-widget/v1/-/CCUJu-CGwD" width="560" height="400" frameborder="1" allowfullscreen="true" style="position:relative;"></iframe></div>
            </div>
        </div>
    )
}
