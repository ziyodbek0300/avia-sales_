            ...
            <Container className={"pb-5 max-w-7xl mx-auto mt-5 text-2xl"}>
                <div className={"main-courses fw-bold fs-4"}>
                    <div style={{ backgroundImage: `url(${bgImg})` }}
                        ...
                        <Link className="text-decoration-none text-white absolute bottom-3 text-3xl text-shadow right-3" to="/video/1">БАА</Link>
                    </div>
                    <div style={{ backgroundImage: `url(${bgImg2})` }}
                        className={"rounded-2xl card p-3 border-0 shadow-sm text-orange-400 font-bold relative"}>
                        <Link className="text-decoration-none text-white absolute bottom-3 text-3xl text-shadow right-3" to="/video/1">Мекка</Link>
                    </div>
                </div>
            </Container>
            <Container className={"pb-5 max-w-7xl mx-auto mt-5 text-2xl"}>
